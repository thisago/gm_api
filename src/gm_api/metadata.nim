...
proc genMetadataBlock*(
  ...
  namespace = "Nim Userscript";                              ## Optional
  ...
  for exclMat in excludeMatch: addMeta(" ", exclMat)
  ...
  result = fmt"""// ==UserScript==
               {metadatas.join("\n")}
               // ==/UserScript==
               // Metadata automatically generated by https://git.ozzuu.com/thisago/gm_api""".unindent
